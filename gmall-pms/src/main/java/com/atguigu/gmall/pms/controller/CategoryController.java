...
public class CategoryController {
    ...
    @GetMapping
    public Resp<List<CategoryEntity>> queryCategoryLevel(@RequestParam(value = "level",defaultValue = "0")Integer level,@RequestParam(value = "parentCid",required = false)Long parentCid){
       List<CategoryEntity> categoryEntities= categoryService.queryCategoryLevel(level,parentCid);
